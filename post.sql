...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th8 09, 2018 lúc 05:15 PM
...
--
ALTER TABLE `post`
  MODIFY `post_number` int(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
COMMIT;
